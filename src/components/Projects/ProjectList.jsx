...
},
{
    ...
    title: "ConsoleLog.Ar",
    description:
    "La página oficial de la marca ConsoleLog.Ar se encuentra actualmente en proceso de desarrollo por un equipo de programadores especializados. Utilizando tecnologías fundamentales como HTML, CSS y JavaScript, estamos comprometidos en crear una plataforma web que refleje la esencia y los valores de nuestra marca, proporcionando una experiencia digital óptima para nuestros usuarios.",
...
},
{
    ...
    title: "Makisan Tech",
    description:
    "La Landing Page de Makisan-Tech, desarrollada con HTML, CSS y JavaScript, fue fruto de una colaboración estrecha con un equipo de desarrolladores front-end. Nuestro objetivo principal fue optimizar la experiencia del usuario, asegurando una navegación fluida y una presentación atractiva que reflejara los valores de la empresa.",
...
},
{
    ...
    title: "Eidos Global",
    description:
    "Como proyecto final para el curso Eidos Global, diseñé una página de presentación personal utilizando HTML, CSS y JavaScript. La implementación de una interfaz interactiva fue fundamental para mejorar la experiencia del usuario, garantizando su adaptabilidad a diferentes dispositivos mediante un diseño responsivo.",
